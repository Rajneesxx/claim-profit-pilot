...
// Overlay (single, no pointer-events bug)
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-black backdrop-blur-none",
...
// Composed Dialog component that ensures single overlay
const DialogWithContent = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Content>,
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content>
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
...
DialogWithContent.displayName = "DialogWithContent"

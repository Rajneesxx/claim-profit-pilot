  ...
  return (
    <footer className="bg-[#01101F]">
      ...
      <div className="bg-[#01101F] pt-[60px] pb-10 px-[100px] max-sm:pt-10 max-sm:pb-5 max-sm:px-5">
        ...
        <div className="flex justify-between items-center border-t-gray-700 max-w-[1240px] mb-5 mx-auto px-0 py-5 border-t border-solid max-sm:flex-col max-sm:gap-5 max-sm:text-center">
          <address className="text-[#A6A6A6] text-xs not-italic">
            <div>Address:</div>
            <div>100 Church Street Manhattan, New York 10007</div>
          </address>
          <div className="flex flex-col items-end gap-2">
            <div className="text-[#A6A6A6] text-[10px] font-bold uppercase">
              RECOGNIZED BY
            </div>
            <div className="flex gap-2">
              <div className="text-[#A6A6A6] text-[10px] font-bold uppercase w-8 h-8 rounded bg-gray-700" />
              <div className="w-8 h-8 rounded bg-gray-700" />
            </div>
          </div>
        </div>

        <div className="flex justify-between items-center border-t-gray-700 max-w-[1240px] mx-auto pt-5 border-t border-solid max-sm:flex-col max-sm:gap-4 max-sm:text-center">
          <div className="text-gray-500 text-xs">
            © 2024 RapidClaims. All rights reserved.
          </div>
          <nav className="flex gap-6">
            <a href="#" className="text-gray-500 text-xs cursor-pointer transition-[color] duration-[0.2s] ease-[ease] hover:text-gray-300">
              Terms of Service
            </a>
            <a href="#" className="text-gray-500 text-xs cursor-pointer transition-[color] duration-[0.2s] ease-[ease] hover:text-gray-300">
              Privacy Policy

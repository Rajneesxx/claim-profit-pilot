  ...
  return (
   <footer className="bg-[#01101F] w-screen relative overflow-hidden m-0 pt-0 mt-0 left-0 right-0">
     <section class="section_home_roi">
        <div class="padding_global">
          <div class="main_container">
            <div class="home_roi_wrapper">
              <div class="home_roi_left">
                <div class="roi_image_wrapper">
                  <div class="rc_logo">
                    <div class="code-embed w-embed"><svg width="100%" viewbox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h2 class="h2_50px fff">Transform Your Revenue Cycle in 30 Days or Less</h2>
                <p class="para_16px is_white">Join leading healthcare organizations already seeing results with RapidClaims.</p>
              </div>
              <div class="home_roi_right">
                <a href="get-in-touch.html" class="mega_link_wrapper line_top_bottom w-inline-block">
                  <h3 class="h3_44px">Request ROI Analysis</h3><img src="images/arrow-right1_1arrow-right1.avif" loading="lazy" alt="" class="arrow_90px">
                </a>
                <a href="get-in-touch.html" class="mega_link_wrapper line_top_bottom w-inline-block">
                  <h3 class="h3_44px">Calculate your savings</h3><img src="images/arrow-right1_1arrow-right1.avif" loading="lazy" alt="" class="arrow_90px">
                </a>
                <a href="get-in-touch.html" class="mega_link_wrapper w-inline-block">
                  <h3 class="h3_44px">Schedule a demo</h3><img src="images/arrow-right1_1arrow-right1.avif" loading="lazy" alt="" class="arrow_90px">
                </a>
              </div>
            </div>
          </div>
    ...
    <div class="footer">
      <div class="padding_global">
        <div class="main_container">
          <div id="w-node-_081cbafd-5c80-6c34-4a36-220a4c16e521-4c16e51d" class="footer_logo">
            <a href="index.html" aria-current="page" class="footer_logo_wrappe w-inline-block w--current">
              <div class="rc_logo">
                <div class="code-embed w-embed"><svg width="100%" viewbox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.5" d="M0.678761 31.4286H4.92114C5.29594 31.4286 5.6 31.7484 5.6 32.1427C5.6 32.5373 5.29594 32.8571 4.92114 32.8571H0.678761C0.303896 32.8571 0 32.5373 0 32.1427C0 31.7484 0.303896 31.4286 0.678761 31.4286Z" fill="currentColor"></path>
                    <path d="M2.77893 29.2857H7.02137C7.3963 29.2857 7.70001 29.6054 7.70001 29.9999C7.70001 30.3946 7.3963 30.7143 7.02137 30.7143H2.77893C2.40393 30.7143 2.10001 30.3946 2.10001 29.9999C2.10001 29.6054 2.40393 29.2857 2.77893 29.2857Z" fill="currentColor"></path>
            ...
            <div class="footer_awards">
              ...
              <div class="footer_awards_image_wrapper">
                <a href="black-book-2025.html" class="footer_awards_link w-inline-block"><img src="images/Screenshot_2025-07-14_at_2.21.40_PM-removebg-preview.png" loading="lazy" alt="" class="footer-img"></a>
                <a href="award.html" class="footer_awards_link w-inline-block"><img src="images/FrostSullivan.png" loading="lazy" alt="" class="footer-img"></a>
              </div>
            </div>
          </div>
          <div class="footer_header">
            <div id="w-node-fadd8fb0-3705-eb0e-ad85-5b9d5c3c7008-4c16e51d" class="div-block-250">
              <div class="footer_link_wrapper">
                <h3 class="h3_16px">PRODUCTS</h3>
                <div class="footer_links">
                  <a href="products/rapid-code.html" class="footer_link w-inline-block">
                    <p>RapidCode</p>
                  </a>
                  <a href="products/rapid-scrub.html" class="footer_link w-inline-block">
                    <p>RapidScrub</p>
                  </a>
                  <a href="products/rapid-cdi.html" class="footer_link w-inline-block">
                    <p>RapidCDI</p>
                  </a>
                </div>
              </div>
              <div class="footer_link_wrapper">
                <h3 class="h3_16px">SOLUTIONS</h3>
                <div class="footer_links">
                  <a href="solutions.html" class="footer_link w-inline-block">
              ...
              <div class="footer_link_wrapper">
                <h3 class="h3_16px">Resources</h3>
                <div class="footer_links">
                  <a href="resources/blogs.html" class="footer_link w-inline-block">
                    <p>Blogs</p>
                  </a>
                  <div class="footer_link none">
                    <p>Case Studies</p>
                  </div>
                  <div class="footer_link none">
                    <p>News</p>
              ...
              <div class="footer_link_wrapper">
                <div class="form-block w-form">
                  <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form" data-wf-page-id="6846c90a13b9a82f202adea1" data-wf-element-id="081cbafd-5c80-6c34-4a36-220a4c16e525"><label for="Email-2" class="field-label">Sign up for our newsletter</label>
                    <div class="form_field_wrapper"><input class="text-field w-input" maxlength="256" name="Email-2" data-name="Email 2" placeholder="Enter email address" type="email" id="Email-2"><input type="submit" data-wait="Please wait..." class="submit-button w-button" value="→"></div>
                  </form>
                ...
                <div id="w-node-_081cbafd-5c80-6c34-4a36-220a4c16e57e-4c16e51d" class="footer_address">
                  <p class="para_12px is_bold is_white">Address</p>
                  <p class="para_12px is_white">605W, 42nd Street, Manhattan, New York 10036</p>
                </div>
              </div>
            </div>
            <div id="w-node-_081cbafd-5c80-6c34-4a36-220a4c16e589-4c16e51d" class="div-block-252">
              <div class="div-block-254">
                <p>© 2025 RapidClaims. All rights reserved.</p>
              </div>
              <div id="w-node-cbe97f62-c58f-a34d-6f6b-456630b853d6-4c16e51d" class="div-block-251">
                <a href="mailto:sales@rapidclaims.ai?subject=Inquiry" class="footer_link grey w-inline-block">
                  <p>Email sales@rapidclaims.ai</p>
                </a>
                <div class="div-block-253">
                  <a href="terms-of-service.html" class="footer_link grey w-inline-block">
                    <p>Terms of Service</p>
                  </a>
                  <a href="privacy-policy.html" class="footer_link grey w-inline-block">
                    <p>Privacy Policy</p>
                  </a>
                  <a href="cookie-policy.html" class="footer_link grey w-inline-block">
                    <p>Cookie Policy</p>
                  </a>
                </div>
                <a id="w-node-_081cbafd-5c80-6c34-4a36-220a4c16e584-4c16e51d" href="https://www.linkedin.com/company/rapidclaims-ai/posts/?feedView=all" class="social_links w-inline-block">
                  <div class="w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="24" height="24" fill="white"></rect>
                      <g clip-path="url(#clip0_205_1140)">
      ...
      </div><img src="images/65f2f511564b4dc62c234412_pattern-2_165f2f511564b4dc62c234412_pattern-2.avif" loading="lazy" alt="" class="footer_abso-2"><img src="images/65f2f511564b4dc62c234412_pattern-1_165f2f511564b4dc62c234412_pattern-1.avif" loading="lazy" alt="" class="footer_abso-1">
    </div>
  </div>
    </footer>
  );

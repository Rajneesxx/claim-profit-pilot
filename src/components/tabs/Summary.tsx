  ...
  return (
    <>
      ...
      <CardContent className="p-8">
        ...
        <div className={`relative ${!isSignedIn ? 'blur-sm' : ''}`}>
          {/* Key Results */}
        ...
        {/* Sign-in overlay for blurred content */}
        {!isSignedIn && (
          <div className="absolute inset-0 flex items-center justify-center bg-background/80 backdrop-blur-sm">
            <div className="text-center p-6">
              <div className="text-lg font-semibold text-foreground mb-2">
                Sign in to view detailed summary
              </div>
              <div className="text-sm text-muted-foreground">
                See your complete ROI analysis and savings breakdown
              </div>
            </div>
          </div>
        )}

        {/* Get ROI Report Button - always visible and accessible */}
        <div className="mb-6 relative z-10">
          <Button 
            onClick={onCalculateROI}
            className="w-full h-14 text-lg font-semibold rounded-xl bg-gradient-to-r from-primary to-primary-variant hover:from-primary-variant hover:to-primary"
          >

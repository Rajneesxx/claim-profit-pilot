  ...
  return (
    <section className="w-full relative px-[100px] py-20 max-sm:px-5 max-sm:py-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
        {/* Left Side - FAQ Header and Contact */}
        <div 
          className="flex flex-col items-center justify-center text-center relative rounded-3xl p-12"
          style={{
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-slate-700 text-4xl font-bold tracking-wide">
              FAQs
            </h2>
          </div>
          
          {/* Subtitle */}
          <p className="text-slate-700 text-lg font-medium tracking-wide text-center mb-8 max-w-sm leading-relaxed">
          ...
          <button 
            ...
            className="flex items-center justify-center gap-3 px-8 py-4 bg-primary hover:bg-primary-variant text-white font-semibold text-lg rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            <svg 
              width="20" 
              height="20" 
